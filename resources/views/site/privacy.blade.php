    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 600px) {
            ...
            h1 { font-size: 22px; }
            a { padding: 12px 16px; font-size: 14px; margin: 6px 4px; }
        }
    </style>
...
<div class="wrap">
    <div class="card">
        ...
        <div class="actions">
            <a class="blue" href="/">صفحه اصلی</a>
            <a class="green" href="/buy">خرید / تمدید</a>
            <a class="dark" href="/terms">شرایط استفاده</a>
        </div>
    </div>
</div>
