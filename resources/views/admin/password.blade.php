...
<head>
<meta charset="utf-8">
<title>تغییر رمز پنل | Scanbridge</title>
...
.card{background:rgba(255,255,255,.85);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border:1px solid rgba(255,255,255,.95);border-radius:24px;box-shadow:0 16px 45px rgba(30,58,138,.16);padding:30px;width:100%;max-width:460px;}
...
.btn-gray{background:linear-gradient(135deg,#64748b,#475569);box-shadow:0 8px 20px rgba(100,116,139,.35);margin-top:10px;}
...
.hint{background:#eff6ff;color:#1e40af;border:1px solid #bfdbfe;border-radius:12px;padding:10px 14px;font-size:13px;margin-bottom:14px;}
</style>
...
<a class="btn btn-gray" href="/admin">بازگشت به پنل</a>
</div>
</div>
